<?php 
	...
	require('config.php');
	get_header();
	$select_last_row= "SELECT lab_id FROM patient WHERE status='1' ORDER BY lab_id DESC LIMIT 0 ,1";
...
<section class="container-fluid">
			...
			<h2 class="title text-center">--Last Patient's Details--</h2>
			<hr>
			<div class="col-md-12">
			<a title="Edit" class="edit_button" href="pat_edit.php?p=<?php echo $id; ?>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
		...
		<div class="col-md-12 text-center bb_1 mb_15 b_1">
			<div class="col-md-4">
...
<section style="margin-top: 25px;" class="container text-center">
	...
	<div class="col-md-12 b_1 bb_1">
		...
		<div class="col-md-4"><p>< 6.1 mmol/L</p></div>
		<div class="col-md-5"><p>< 7.8 11.1 mmol/L</p></div>
	</div>
